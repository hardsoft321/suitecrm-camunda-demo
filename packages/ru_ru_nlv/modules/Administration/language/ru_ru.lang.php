...
// SearchWrapper
'LBL_SEARCH_HEADER' => 'Поиск',
'LBL_SEARCH_HEADER_DESC' => 'Управление параметрами поиска',
'LBL_SEARCH_WRAPPER' => 'Search (New)',
'LBL_SEARCH_WRAPPER_DESC' => 'Выбор поисковых систем и модулей, в которых проводится поиск',
...
'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Для работы Elasticsearch требуется настроенный сервер. Более подробная информация указана в <a href="https://docs.suitecrm.com/ru/admin/administration-panel/search/elasticsearch/">документации</a>.',
...
'LBL_SEARCH_CONTROLLER' => 'Поисковая система',
'LBL_SEARCH_CONTROLLER_HELP' => 'Выберите систему, при помощи которой будет осуществляться поиск.',
...
'LBL_SEARCH_MODULES_HELP' => 'Выберите модули, в которых будет осуществляться поиск:',
